...
public class UserDto implements Serializable {
    ...
    @Unique(fieldName = "name", caseSensitive = false, repository = UserRepository.class, groups = {ValidationGroups.Common.class})
    String phone;
    ...
    @Unique(fieldName = "email", caseSensitive = false, repository = UserRepository.class, groups = ValidationGroups.Common.class)
    String email;

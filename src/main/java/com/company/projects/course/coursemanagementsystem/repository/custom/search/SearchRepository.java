package com.company.projects.course.coursemanagementsystem.repository.custom.search;
...
@Repository
public interface SearchRepository<E, I> extends CustomNameRepository<E, I>,
        CustomEmailRepository<E, I>, CustomPhoneRepository<E, I> {
}
